...
*/
	...
	public String upload_file(@RequestHeader("image") MultipartFile file,@RequestHeader("secret-key") String secretkey,@RequestHeader("company-id") String companyid,@RequestHeader("ticket-id") String ticketid) throws ParseException, IOException
	{
		JSONObject status = new JSONObject();
		try{
			if(rfidDAO.Authentication(companyid, secretkey)==true)
